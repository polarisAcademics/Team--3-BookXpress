      ...
      <div className="max-w-md w-full space-y-8 bg-theme-secondary p-8 rounded-lg shadow-xl">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-theme-secondary">
            Or{' '}
            <a href="/signup" className="font-medium text-[var(--accent-color)] hover:text-[var(--accent-hover)]">
          ...
          <div className="rounded-md shadow-sm -space-y-px">
            <div>
              ...
              <input
                ...
                className="appearance-none rounded-none relative block w-full px-3 py-2 bg-theme-primary text-theme-primary placeholder:text-theme-secondary rounded-t-md focus:outline-none focus:ring-[var(--accent-color)] focus:border-[var(--accent-color)] focus:z-10 sm:text-sm"
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                className="appearance-none rounded-none relative block w-full px-3 py-2 bg-theme-primary text-theme-primary placeholder:text-theme-secondary rounded-b-md focus:outline-none focus:ring-[var(--accent-color)] focus:border-[var(--accent-color)] focus:z-10 sm:text-sm"
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-theme-secondary text-theme-secondary">Or continue with</span>
              </div>
            </div>
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <button
                ...
                className="w-full inline-flex justify-center py-2 px-4 rounded-md shadow-sm bg-theme-secondary text-sm font-medium text-theme-secondary hover:bg-theme-primary disabled:opacity-50 disabled:cursor-not-allowed"
                disabled={loading}
              >
